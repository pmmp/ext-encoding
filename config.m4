...
if test "$PHP_ENCODING" != "no"; then
  ...
  PHP_NEW_EXTENSION(encoding, encoding.cpp classes/ByteBufferReader.cpp classes/ByteBufferWriter.cpp classes/Types.cpp, $ext_shared,,-std=c++20 -Wall -Werror, yes)
